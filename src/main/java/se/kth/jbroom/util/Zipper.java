...
public class Zipper {
    ...
    /**
     * Compresses a File and saves it to the given target file using the
     * standart deflate algorithm
     *
    ...
    public static void unzip(File zipFile, File outdir) {
        ...
        if (outdir.exists() && !outdir.isDirectory()) {
            System.err.println("visionCore.util.Zipper.unzip(zip, outdir): 'outdir' is not a directory!");
            return;
        }
        ...
        if (!outdir.exists()) {
            ...
            if (!outdir.mkdirs()) {
                System.err.println("visionCore.util.Zipper.unzip(zip, outdir): 'outdir' couldn't be created.");
                return;
            }
        }
