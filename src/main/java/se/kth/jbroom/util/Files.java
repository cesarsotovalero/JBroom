...
public class Files {
    ...
    public static void copyFileUsingOS(File source, File dest) {
        ...
        try {
            java.nio.file.Files.copy(source.toPath(), dest.toPath(), REPLACE_EXISTING);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static void moveFileUsingOS(File source, File dest) {
        ...
        try {
            java.nio.file.Files.move(source.toPath(), dest.toPath(), REPLACE_EXISTING);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static String getExtension(File f) {
        ...
        String x = "";
        try {
            x = name.substring(name.lastIndexOf(".") + 1, name.length());
        } catch (Exception e) {
        }
