...
/**
 * A reporter visitor for the Jacoco exec file in order to extract coverage
 * information. That help us in the ordering of test suites.
 * <p/>
 * The reporter visitor extract the coverage information of a source position in
 * the following way: 1. Search for the method containing the source position 2.
 * Extract the coverage metrics for that method in the current bundle. 3.
 * Returns a float indicating the class and the coverage percent sum for those
 * method
 * <p/>
 *
 */
public class JuncoReportVisitor extends AbstractGroupVisitor implements IReportVisitor {
    ...
    /**
     * Constructor of the reporter visitor
     *
